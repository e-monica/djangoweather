...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=1F1E856A-A5AF-4352-910E-A8BE009E671B")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_color = "good"
		 	...
		 	category_color = "moderate"
		  	...
		  	category_description = "(101 - 150) Although general public is not likely to be affected at this AQI range, people with lung disease, older adults and children are at great risk."
		  	category_color = "usg"
		...
		return render (request, 'home.html', {
			...
			api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=10305&distance=25&API_KEY=1F1E856A-A5AF-4352-910E-A8BE009E671B")
